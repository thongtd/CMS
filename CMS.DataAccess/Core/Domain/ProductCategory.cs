...
namespace CMS.DataAccess.Core.Domain
{
    ...
    public class ProductCategory
    {
        ...
        public static implicit operator ProductCategory(ProductCategoryRequest model)
        {
            if (model == null)
            {
                return null;
    ...
    public class ProductCategoryMap : EntityTypeConfiguration<ProductCategory>
    {
        public ProductCategoryMap()
        {
            ...
            HasMany(x => x.Products).WithRequired(x => x.ProductCategory).HasForeignKey(x => x.ProductCategoryId);
        }
    }
}
